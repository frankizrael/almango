...
<section class="pdf_data_ins pdf_options">
	<div class="pdf_options__flex">
		...
		<div class="pdf_options__border">
			...
			?>
			<div class="pdf_options__content">
				<div class="title">TRANSMICIÓN</div>
...
<section class="pdf_options pdf_data_foot">
	<div class="pdf_options__flex">
		...
		<div class="pdf_options__border">
			...
			<div class="pdf_options__content">
				<div class="title"><?php echo get_field('number_box_1',$id); ?></div>
				<div class="value"><?php echo get_field('text_box_1',$id); ?> <?php echo get_field('desc_box_1',$id); ?></div>
			</div>
			<div class="pdf_options__content">
				<div class="title"><?php echo get_field('number_box_2',$id); ?></div>
				<div class="value"><?php echo get_field('text_box_2',$id); ?> <?php echo get_field('desc_box_2',$id); ?></div>
			</div>
			<div class="pdf_options__content">
				<div class="title"><?php echo get_field('number_box_3',$id); ?></div>
				<div class="value"><?php echo get_field('text_box_3',$id); ?> <?php echo get_field('desc_box_3',$id); ?></div>
			</div>
			<div class="pdf_options__content">
				<div class="title"><?php echo get_field('number_box_4',$id); ?></div>
				<div class="value"><?php echo get_field('text_box_4',$id); ?> <?php echo get_field('desc_box_4',$id); ?></div>
			</div>
			<div class="pdf_options__content">
				<div class="title"><?php echo get_field('number_box_5',$id); ?></div>
				<div class="value"><?php echo get_field('text_box_5',$id); ?> <?php echo get_field('desc_box_5',$id); ?></div>
			</div>
			<div class="pdf_options__content">
				<div class="title"><?php echo get_field('number_box_6',$id); ?></div>
				<div class="value"><?php echo get_field('text_box_6',$id); ?> <?php echo get_field('desc_box_6',$id); ?></div>
			</div>
			<div class="pdf_options__content">
				<div class="title"><?php echo get_field('number_box_7',$id); ?></div>
				<div class="value"><?php echo get_field('text_box_7',$id); ?> <?php echo get_field('desc_box_7',$id); ?></div>
			</div>
			<div class="pdf_options__content">
