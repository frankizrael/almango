...
Transforms the native WordPress gallery to a responsive gallery, respecting image proportions. Includes swipebox, but also compatible with most third party lightbox plugins.
...
Since version 2.2.1 the plugin includes a copy of swipebox. A nice responsive lightbox, which you can activate from the RGG Gallery page in your wordpress dashboard.
