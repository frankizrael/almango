...
class THWCFE_Public_Checkout extends THWCFE_Public {
	...
	*******************************************************/
	...
	/*public function may_display_repeat_fields_value_old($order_id, $key, $field, $rfnames, $is_nl2br=true){
		$html = '';
	 ...
	 */
	/*public function display_custom_fields_in_order_details_page_customer_old($order){
	...
	/*public function display_custom_fields_in_order_details_page_customer($order){		
		...
		$html = '';
		foreach($sections as $sname => $section){
			if(!in_array($sname, $dis_sections)){
